...
extern void		event_cancel(LPEVENT * event);			// Event cancellation
extern long		event_processing_time(LPEVENT event);	// Return execution time
extern long		event_time(LPEVENT event);			// Return remaining time
extern void		event_reset_time(LPEVENT event, long when);	// Reset run time
